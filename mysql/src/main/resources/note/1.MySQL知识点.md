...
输出结果：
1	SIMPLE	employees_explain		ref	idx_name_age_position	idx_name_age_position	74	const	1	100.00	
1	SIMPLE	employees_explain		ref	idx_name_age_position	idx_name_age_position	78	const,const	1	100.00	
...
输出结果：
1	SIMPLE	employees_explain		ref	idx_name_age_position	idx_name_age_position	78	const,const	1	100.00	
1	SIMPLE	employees_explain		ALL					3	33.33	Using where
1	SIMPLE	employees_explain		ALL					3	33.33	Using where
...
输出结果：
1	SIMPLE	employees_explain		ALL					3	100.00	Using where
...
输出结果
1	SIMPLE	employees_explain		ALL	idx_hire_time				3	100.00	Using where
1	SIMPLE	employees_explain		ALL					3	100.00	Using where
...
输出结果：
1	SIMPLE	employees_explain		ref	idx_name_age_position	idx_name_age_position	140	const,const,const	1	100.00	
1	SIMPLE	employees_explain		range	idx_name_age_position	idx_name_age_position	78		1	33.33	Using index condition
...
输出结果：
1	SIMPLE	employees_explain		ALL					3	33.33	Using where
1	SIMPLE	employees_explain		range	idx_name_age_position	idx_name_age_position	74		1	100.00	Using index condition
...
输出结果：
1	SIMPLE	employees_explain		index		idx_name_age_position	140		3	33.33	Using where; Using index
```
...
explain select * from employees_explain where name='1000';
输出结果：
1	SIMPLE	employees_explain		ALL	idx_name_age_position				4	25.00	Using where
...
输出结果：
1	SIMPLE	employees_explain		ALL	idx_age				4	100.00	Using where
1	SIMPLE	employees_explain		range	idx_age	idx_age	4		1	100.00	Using index condition
